...
labels4 = c("R1_fitted_inv"= paste(c("\u2190 Extension    ", "Z", "      Flexion \u2192"), collapse=collapse_sequence), 
            ...
            "RF_fitted"=     paste(c("\u2190 Innenrotation", "Y", "Au�enrotation \u2192"), collapse=collapse_sequence))
labels4_raw <- labels4
...
#   scale_x_continuous(name = "Zeit (%)", limits = c(0,100), breaks=c(0,20,40,60,80,100))+
#   scale_y_continuous(name = "Rotation (�)")+
#   ggtitle("Rotationen für Alma auf verschiedenen Böden")+
#   theme_bw()+
...
#   scale_x_continuous(name = "Zeit (%)", limits = c(0,100), breaks=c(0,20,40,60,80,100))+
#   scale_y_continuous(name = "Rotation (�)")+
#   ggtitle("Rotationen für Berta auf verschiedenen Böden")+
#   theme_bw()+
#   theme(legend.position="top", plot.title = element_text(hjust = 0.5))
# 
...
#   scale_x_continuous(name = "Zeit (%)", limits = c(0,100), breaks=c(0,20,40,60,80,100))+
#   scale_y_continuous(name = "Rotation (�)")+
#   # ggtitle("Rotationen für Alma auf verschiedenen B�den")+
#   theme_bw()+
...
#   scale_x_continuous(name = "Zeit (%)", limits = c(0,100), breaks=c(0,20,40,60,80,100))+
#   scale_y_continuous(name = "Rotation (�)")+
#   #ggtitle("Rotationen gemittelt auf verschiedenen B�den")+
#   theme_bw()+
