...
# import all commands
from pk_src import centerPoint, centroidPoint, normalize, eigenvector, alignObj, exportData, rangeObj, \
...
def initializePlugin(mobject):
    ...
    for mod_name in sys.modules.keys():
        if 'pk_src' in mod_name and not (sys.modules[mod_name] is None):
