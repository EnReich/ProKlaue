"""
Calculates the convex hull using the scipy-library (based on *Qhull*) of the current object and creates a new transform node. The name of the new transform node will be the object's name with the suffix '_ch'
